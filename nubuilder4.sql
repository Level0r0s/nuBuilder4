...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2017 at 12:58 AM
...
INSERT INTO `aaaa` (`aaaa_id`, `t_test`, `t_number`) VALUES
('s14916358043853', '', 11);

-- --------------------------------------------------------

--
-- Table structure for table `aaaaaall`
--

CREATE TABLE `aaaaaall` (
  `aaaaaall_id` varchar(25) NOT NULL,
  `Field000` varchar(1000) NOT NULL,
  `Field001` varchar(1000) NOT NULL,
  `Field002` varchar(1000) NOT NULL,
  `Field004` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `aaaaaall`
--

INSERT INTO `aaaaaall` (`aaaaaall_id`, `Field000`, `Field001`, `Field002`, `Field004`) VALUES
('s14916788516852', 'cfghhj', '', '', ''),
('s14916789261549', '35y7', '', '', '');
...
('s14916356411646', 'c14916355747536919', 'Test', 't_test', 'l', '', 20, 200),
('s14916356411648', 'c14916355747536919', 'number000', 't_number', 'l', '', 30, 200),
...
('c14916355747536919', 'browseedit', 'FF2', 'Fast Form 2', 'aaaa', 'aaaa_id', '', 0, 0, 'SELECT * FROM aaaa', '');
...
('568ddbbf00aae51', '56773cb405f4913', 'company', 'subform', 'employee_sf', 'Subform', '567898dbc543710', 10, 113, 85, 500, 250, '1', 'right', '0', '0', '', '', '', '568b508eec00d80', '', 'i', '', '', '', '', '', '', '', '', '', '', '', '', '5678ab2c48c5c41', 'emp_company_id', '1', '1', 'f', 'employee', 0, '', '', '', '<div style=\\"top:0px;left:0px;width:200px;height:200px;background-color:tan;\\">Hello World</div>'),
('569dc5613f24e14', 'nuhome', '', 'run', 'run_browse', 'Company', '58be4c05188661c', 170, 159, 64, 150, 30, '1', 'right', '1', '0', '', '', '', '56773cb405f4913', '', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', ''),
...
('575a326a877e7ed', 'nuhome', '', 'run', 'run_debug', 'Debug', '58be4c05188661c', 200, 207, 64, 150, 30, '1', 'left', '1', '0', '', '', '', 'nudebug', '', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', ''),
...
('583f37bc5bba917', 'nuffobjects', 'zzzzsys_object', 'input', 'ff_field', 'Field Name', '5840d1f62187912', 20, 20, 30, 196, 18, '1', 'left', '1', '0', '', '', '', '', '', '', '', '', '', '', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'text', '', ''),
('583f37d3224bcc8', 'nuffobjects', 'zzzzsys_object', 'input', 'ff_label', ' Label', '5840d1f62187912', 10, 49, 24, 200, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', 0, '', 'text', '', ''),
('583f4ed643fcc3b', 'nufflaunch', 'zzzzsys_form', 'subform', 'obj_sf', ' ', '583361606251aef', 10, 69, 563, 474, 304, '1', 'right', '0', '0', '', '', '', 'nuffcustomobjects', '', 'i', '', '', '', '', '', '', '', '', '', '', '', 'zzzzsys_object', 'nuffobjects', 'zzzzsys_debug_id', '1', '1', 'g', '', 0, '', '', '', ''),
...
('58a091f8d1d6dc7', 'nuhome', '', 'run', 'run_invoice', 'Invoice', '58be4c05188661c', 190, 63, 64, 150, 30, '1', 'right', '1', '0', '', '', '', '58a08a1abc4782c', '', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', ''),
...
('58a0c3d66b2daa7', '58a08a1abc4782c', 'invoice', 'input', 'inv_number', 'Invoice Number', '58a08a1abc48c9a', 30, 32, 168, 50, 25, '1', 'right', '0', '0', '', 'nuTotal("invoice_item.ite_total")', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 50, '', 'nuAutoNumber', '', ''),
...
('58bf0bfb0e531b2', 'nuhome', '', 'run', 'run_test', 'Test', '58be4c05188661c', 180, 111, 64, 150, 30, '1', 'right', '1', '0', '', '', '', '58bf0b972c2a447', '', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', ''),
...
('58d6f5a644bae0c', 'nufflaunch', 'zzzzsys_form', 'word', 'ffwrd', 'Objects for this Fast Form ', '583361606251aef', 20, 40, 564, 455, 17, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', ''),
('58d6fbc151d152f', 'nufflaunch', 'zzzzsys_form', 'input', 'fastform_table', 'New Table Name', '583361606251aef', 30, 90, 112, 140, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', ''),
...
('58dfee3c5b0286944', 'nufflaunch', 'zzzzsys_form', 'run', 'fastform_build', 'Build', '583361606251aef', 70, 87, 364, 173, 21, '1', 'left', '1', '0', '', '', '', 'nufastform', '', 'b', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', ''),
...
('s14916356411640', 'c14916355747536919', 'Main', 10);
...
--
-- Table structure for table `___nu158e80aa8c9474___`
--

CREATE TABLE `___nu158e80aa8c9474___` (
  `zzzzsys_object_id` varchar(25) NOT NULL,
  `sob_all_zzzzsys_form_id` varchar(300) NOT NULL,
  `sob_all_table` varchar(300) NOT NULL,
  `sob_all_type` varchar(300) NOT NULL,
...
--
-- Indexes for table `aaaaaall`
--
ALTER TABLE `aaaaaall`
  ADD PRIMARY KEY (`aaaaaall_id`);
