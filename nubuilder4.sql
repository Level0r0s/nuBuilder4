...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2016 at 07:17 AM
...
('57eaf962bd09b68', 'nuphplibrary', 'Description', 'sph_description', 'l', '', 'sph_description', 20, 250),
('57eaf962bd09705', 'nuphplibrary', 'Code', 'sph_code', 'l', '', 'sph_code', 10, 150),
('57eaf962bd09f4c', 'nuphplibrary', 'Group', 'sph_group', 'l', '', 'sph_group', 30, 150),
('57eaf962bd0a240', 'nuphplibrary', 'Launch By', 'CONCAT(sfo_code, '' - '', sfo_description)', 'l', '', 'sfo_code', 40, 300);
...
('nuphplibrary', 'browseedit', 'PHPLIB', 'PHP Code Library', 'zzzzsys_php_library', 'zzzzsys_php_library_id', '', '', '', '', '', '', '', '', '', '', 'SELECT * FROM zzzzsys_php\nLEFT JOIN zzzzsys_form ON zzzzsys_form_id = sph_zzzzsys_form_id\nORDER BY sph_code\n', '1', '', '', '0', '', '', '1', '', '', '1', '', '', '1', '', '', '0', '', '', '', '', '', '', '', '$(''#sph_php'').addClass(''php'');\n\n$(''.php'').dblclick(function() {\n	nuOpenAce(''PHP'', this.id);\n});\n');
...
('57eb03abed05e20', 'nuphplibrary', 'lookup', 'sph_zzzzsys_php_id', 'Include', '57eaf962bd0a957', 60, 556, 152, 100, 18, '1', 'right', 'noblanks', '0', '', '', '', '', '', '', '', '', '0', 'SELECT zzzzsys_form_id, CONCAT(sfo_code, '' - '', sfo_description)\nFROM zzzzsys_form\nORDER BY sfo_code', 'sfo_code', 'sfo_description', '220', '', 'nunonsystemform', '', '', '', '', '', '', '', '', '', '');
...
('57eb1c9e4a0608f', '57578be0057a49f', ''),
('57eb1c9e4a06660', '57578be0057a49f', '');
