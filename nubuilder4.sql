...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2017 at 12:57 AM
...
('s15029391687971', 's15028829289853', 'onclick', 'nuAddColumns()'),
...
('s15028831569399', 'launch', 'FR', 'Fast Report', '', '', '', 0, 0, 'SELECT * FROM Launch Form 0', '\n$(''#list'')\n.addClass(''nuScroll'')\n.removeClass(''nuReadOnly'');\n\n\n\nfunction nuAddColumns(){\n    \n    $(''#report_fields'').html('''');\n        \n    sf          = nuSubformObject(''subform'').rows;\n\n    for(var i = 0 ; i < sf.length ; i++){\n        \n        var l   = sf[i][1];\n        var w   = sf[i][4];\n        var c   = sf[i][5];\n        var a   = sf[i][3];\n        \n        if(l!='''' && w!='''' && a!=''''){\n            $(''#report_fields'').append(nuNewColumn(i, l, w, c, a));\n        }\n        \n        \n    }\n    \n}\n\n\n\nfunction nuNewColumn(i, l, w, c, a){\n\n    var col = c==0?''#00adef'':''#7cc242'';\n    \n    var s = "<div id=''rf" + i + "'' style=''padding:5px;display:inline-block;height:25px;font-size:16px;background-color:" + col + ";border:none;text-align:" + a + ";width:" + (w*3) + "''>" + l + "</div> ";\n    \n    return s;\n\n}\n\n\n\n\n\n\nwindow.nuReportList\n\n\n$(''#report_fields'').append(nuNewColumn(0, ''label'', 150, 0, ''left''));\n$(''#report_fields'').append(nuNewColumn(1, ''label'', 100, 1, ''''));\n\n'),
...
('s15028829289851', 's15028829289845', 'invoice', 'input', 'fieldname', 'Field Name', 's15028829289846', 50, 50, 150, 200, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'nuScroll', 'String($(''#list'').val()).split("\\n")', '', ''),
('s15028829289852', 's15028829289845', 'invoice', 'select', 'align', 'Align', 's15028829289846', 80, 80, 180, 70, 16, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '0', 'left|Left|\nright|Right|\ncenter|Center', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
('s15028829289853', 's15028829289845', 'invoice', 'input', 'width', 'Width', 's15028829289846', 110, 110, 210, 60, 18, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'number', '', '', ''),
('s15028829289854', 's15028829289845', 'invoice', 'input', 'sum', 'Sum<br>Column', 's15028829289846', 140, 140, 240, 55, 18, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'checkbox', '', '', ''),
('s15028831569405', 's15028831569399', 'Launch Form 0', 'lookup', 'table', 'Table', 's15028831569400', 10, 31, 103, 100, 20, '1', 'left', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', 'code', 'description', '200', '', 's14993014809858', '\nif($(''#fieldlist'').val() != ''''){\n        \n    var e   = "var fl  = " + eval($(''#fieldlist'').val());\n    \n    eval(e);\n\n    $(''#list'').val(fl.join("\\n"));\n    \n}\n\n\n', '', 'zzzzsys_report_data', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'nuScroll', '[''North'',''South'',''East'',''West'']', '', ''),
('s15029744151077', 's15029744151073', 'Launch Form 0', 'input', 'field00', 'text00', 's15029744151074', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15029248391113', 's15028831569399', 'Launch Form 0', 'html', 'portrait', 'Fields Used', 's15028831569400', 40, 274, 103, 1070, 26, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''report_fields'' style=''background-color:lightgrey;text-align:left;height:150px;border:none;''>\n    \n</div>', ''),
('s15029225871322', 's15028831569399', 'Launch Form 0', 'textarea', 'list', '<b>Field Name </b>Choices', 's15028831569400', 30, 31, 938, 235, 203, '1', 'left', '0', '1', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''adiv'' style=''text-align:center;width:117px;border:1px solid red;'' class=''nuBreadcrumb''>\n    Hello World\n</div>', ''),
('s15028831569407', 's15028831569399', 'Launch Form 0', 'html', 'rwidths', 'Paper Widths', 's15028831569400', 50, 313, 103, 717, 35, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''nufld0'' style=''background-color:#BABABA;text-align:right;border:none;width:444px;''>A5 Portrait</div>\n<div id=''nufld1'' style=''background-color:#BABABA;text-align:right;border:none;width:630px;''>A5 Landscape</div>\n\n<div id=''nufld2'' style=''background-color:#BABABA;text-align:right;border:none;width:630px;''>A4 Portrait</div>\n<div id=''nufld3'' style=''background-color:#BABABA;text-align:right;border:none;width:648px;''>Letter Portrait</div>\n<div id=''nufld4'' style=''background-color:#BABABA;text-align:right;border:none;width:648px;''>Legal Portrait</div>\n\n<div id=''nufld5'' style=''background-color:#BABABA;text-align:right;border:none;width:840px;''>Letter Landscape</div>\n\n<div id=''nufld6'' style=''background-color:#BABABA;text-align:right;border:none;width:891px;''>A4 Landscape</div>\n<div id=''nufld7'' style=''background-color:#BABABA;text-align:right;border:none;width:1068px;''>Legal Landscape</div>\n\n\n\n', ''),
('s15028831569408', 's15028831569399', 'Launch Form 0', 'subform', 'subform', 'Report Columns', 's15028831569400', 70, 71, 103, 640, 159, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', 's15028829289845', 'trl_language', '1', '1', 'g', 'invoice', 89, 'N|$ 1,000.00', 'file', '', '', ''),
('s15029228060163', 's15028831569399', 'Launch Form 0', 'word', 'reportwidth', 'Report Detail', 's15028831569400', 60, 250, 103, 263, 22, '1', 'left', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''adiv'' style=''text-align:center;width:117px;border:1px solid red;'' class=''nuBreadcrumb''>\n    Hello World\n</div>', ''),
('s15029744151078', 's15029744151073', 'Launch Form 0', 'input', 'field01', 'text01', 's15029744151074', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15029332528955', 's15028831569399', 'Launch Form 0', 'input', 'fieldlist', 'list', 's15028831569400', 20, 1, 103, 400, 20, '1', 'left', '0', '2', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', 'code', 'description', '200', '', 's14993014809858', '', '', 'zzzzsys_report_data', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'text', '[''North'',''South'',''East'',''West'']', '', ''),
('s15029319353711', 's15028829289845', 'invoice', 'input', 'fieldtitle', 'Field Title', 's15028829289846', 50, 50, 150, 200, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
