...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2017 at 12:44 AM
...
('s14988197679900', 's14988197679899', 'onclick', 'nuTempPHP();'),
...
('58a094d695573f2', '58a08a91c9b59a9', 'invoice_item', 'calc', 'ite_total', 'Total', '58a08a91c9b6df4', 40, 22, 390, 76, 18, '1', 'right', '0', '0', '', 'nuTotal("ite_units") * nuTotal("ite_unit_price") = nuTotal("ite_total")', 'N|$ 1,000.00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
...
('s14988197679899', 'nuselect', 'zzzzsys_select', 'input', 'phpbutton', 'CREATE TABLE PHP code', 's14930617882374', 30, 19, 810, 229, 20, '1', 'center', '1', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', ''),
...
('s14951260604813', 'nuselect', 'zzzzsys_select', 'html', 'nusvg', 'Fields<br>and<br>Relationships', 's14930617882374', 50, 48, 89, 700, 200, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '<iframe id=''sqlframe'' src=''nuselect.php'' style=''height:200px;width:700px''>\n</iframe>', ''),
('s14952406757366', 'nuselect', 'zzzzsys_select', 'input', 'sse_resize', 'Resize', 's14930617882374', 40, 16, 689, 100, 16, '1', 'left', '1', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'range', '', '', ''),
...
('s14960767003439', 'nuselect', 'zzzzsys_select', 'textarea', 'sse_sql', 'SQL', 's14930617882374', 60, 45, 810, 229, 344, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
...
('s14980423027074', 'nuselect', 'zzzzsys_select', 'word', 'wrdsql', 'SQL', 's14930617882374', 70, 0, 810, 229, 16, '1', 'center', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
...
('s14991169265577', '', '', '', '$t  = [''zzzzsys_form'',''zzzzsys_object'',''zzzzsys_tab'',''zzzzsys_php'',''zzzzsys_php_library'',''zzzzsys_event'',''zzzzsys_browse''];\n\n\nfor($i = 0 ; $i < count($t) ; $i++){\n    \n    $table  = $t[$i];\n    \n    nuRunQuery("DROP TABLE IF EXISTS sys_$table");\n    nuRunQuery("CREATE TABLE sys_$table SELECT * FROM $table");\n    \n}\n\n//-- KEEP FORMs with ids that start with ''nu''\n\n$s  =  "\nDELETE FROM sys_zzzzsys_form \nWHERE zzzzsys_form_id NOT LIKE ''nu%'' \n";\n\nnuRunQuery($s);\n\n//-- KEEP TABs from FORMs with ids that start with ''nu''\n\n$s  =  "\nDELETE FROM sys_zzzzsys_tab \nWHERE syt_zzzzsys_form_id NOT IN (SELECT zzzzsys_form_id FROM sys_zzzzsys_form)\n";\n\nnuRunQuery($s);\n\n//-- KEEP OBJECTs from TABs where FORMs with ids that start with ''nu''\n\n$s  =  "\nDELETE FROM sys_zzzzsys_object \nWHERE sob_all_zzzzsys_tab_id NOT IN (SELECT zzzzsys_tab_id FROM sys_zzzzsys_tab)\n";\n\nnuRunQuery($s);\n\n//-- KEEP PHP with ids that start with ''nu'' or match the above OBJECT list.\n\n\n$s  =  "\nDELETE FROM sys_zzzzsys_php \nWHERE sph_zzzzsys_form_id NOT LIKE ''nu%''\nAND sph_zzzzsys_form_id NOT IN (SELECT zzzzsys_object_id FROM sys_zzzzsys_object)\n";\n\nnuRunQuery($s);\n\n\n//-- PHP LIBRARY\n\n$s  =  "\nDELETE FROM sys_zzzzsys_php_library \nWHERE spl_zzzzsys_php_id NOT IN (SELECT zzzzsys_php_id FROM sys_zzzzsys_php)\n";\n\nnuRunQuery($s);\n\n//-- KEEP BROWSEs from FORMs with ids that start with ''nu''\n\n$s  =  "\nDELETE FROM sys_zzzzsys_browse \nWHERE sbr_zzzzsys_form_id NOT IN (SELECT zzzzsys_form_id FROM sys_zzzzsys_form)\n";\n\nnuRunQuery($s);\n\n\n//-- KEEP EVENTs, from OBJECTs, from FORMs with ids that start with ''nu''\n\n$s  =  "\nDELETE FROM sys_zzzzsys_event \nWHERE sev_zzzzsys_object_id NOT IN (SELECT zzzzsys_object_id FROM sys_zzzzsys_object)\n";\n\nnuRunQuery($s);\n\n\nprint ''Done!'';\n\n\n\n\n\n', '', '', '', '');
...
('s14990193555021', 'INV', 'Invoice', 'test', 's14990147062807', 'nublank', ''),
...
('s14991344520331', 'qq', '{"tables":[{"id":"boxc14991341586414734","position":{"top":56.99045944213867,"left":319.9924621582031},"tablename":"zzzzsys_php_library","alias":"","checkall":true,"checkboxes":[false,false,false]},{"id":"boxc14991341667474735","position":{"top":50,"left":43.98845291137695},"tablename":"zzzzsys_php","alias":"","checkall":true,"checkboxes":[false,false,false,false,false,false,false,false,false]},{"id":"boxc14991341711624736","position":{"top":54.99497604370117,"left":601.9954833984375},"tablename":"zzzzsys_php","alias":"lib","checkall":true,"checkboxes":[false,false,false,false,false,false,false,false,false]}],"joins":{"field_0_boxc14991341667474735--field_1_boxc14991341586414734":"","field_0_boxc14991341711624736--field_2_boxc14991341586414734":""}}', 'SELECT\n    zzzzsys_php_library.*,\n    zzzzsys_php.*,\n    lib.*\n\nFROM\n    zzzzsys_php_library\n        JOIN zzzzsys_php ON zzzzsys_php.zzzzsys_php_id = zzzzsys_php_library.spl_zzzzsys_php_id\n        JOIN zzzzsys_php_library ON lib.zzzzsys_php_id = zzzzsys_php_library.spl_library_zzzzsys_php_id\n', 83, '');
