...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2017 at 02:35 AM
...
('585efbcfe4e0558', '585efbcfe4dfaf4', 'Parent', 'thevalue', 'l', '', 'thevalue', 10, 300),
('585efbcfe4e0ba2', '585efbcfe4dfaf4', ' ', 'thefilter', 'l', '', 'thefilter', 20, 222),
('586d9616d1a4bf2', '585efbcfe4dfaf4', ' ', 'theform', NULL, NULL, 'theform', 30, 111);
...
('586d93d209bdbe2', '23435', '', '2017-01-05 11:01:14'),
('586d97328a46908', 'SELECT thevalue,thevalue,thefilter,theform\n FROM ___nu1586d9731f147d___\n WHERE  ( (thevalue LIKE  "%585efbcfe4dfaf4%" OR thefilter LIKE  "%585efbcfe4dfaf4%" OR theform LIKE  "%585efbcfe4dfaf4%") ) LIMIT 0, 0', '', '2017-01-05 11:15:38'),
('586d98282d379ef', 'SELECT company_id,com_name,com_address,com_suburb,com_phone\n FROM company  LEFT JOIN business ON business_id = com_business_id LIMIT 0, 6', '', '2017-01-05 11:19:44'),
('586d982a6f287b3', 'SELECT zzzzsys_user_id,sus_name,sus_email,sug_description\n FROM zzzzsys_user  LEFT JOIN zzzzsys_user_group ON sus_zzzzsys_user_group_id = zzzzsys_user_group_id \n WHERE  ( (sus_name LIKE  "%Admin%" OR sus_email LIKE  "%Admin%" OR sug_description LIKE  "%Admin%") ) \n ORDER BY sus_name LIMIT 0, 9', '', '2017-01-05 11:19:46'),
('586d982b097fb08', 'SELECT thevalue,thevalue,thefilter,theform\n FROM ___nu1586d982a7ecff___\n WHERE  ( (thevalue LIKE  "%585efbcfe4dfaf4%" OR thefilter LIKE  "%585efbcfe4dfaf4%" OR theform LIKE  "%585efbcfe4dfaf4%") ) LIMIT 0, 0', '', '2017-01-05 11:19:47'),
('586d9851c87764f', 'SELECT zzzzsys_form_id,sfo_code,sfo_description\n FROM zzzzsys_form LIMIT 0, 39', '', '2017-01-05 11:20:25'),
('586d98634910b4d', 'SELECT zzzzsys_form_id,sfo_type,sfo_code,sfo_description\n FROM zzzzsys_form\n ORDER BY sfo_code LIMIT 0, 39', '', '2017-01-05 11:20:43'),
('586d986c752a85b', 'SELECT zzzzsys_form_id,sfo_code,sfo_description\n FROM zzzzsys_form LIMIT 0, 39', '', '2017-01-05 11:20:52'),
('586d9919100b30a', 'SELECT zzzzsys_object_id,sob_all_fast_form_description,sob_all_id,sob_all_label,sob_all_type\n FROM zzzzsys_object\n WHERE sob_all_fast_form_description != '''' LIMIT 0, 210', '', '2017-01-05 11:23:45'),
('586d991d7011a59', 'SELECT zzzzsys_form_id,sfo_code,sfo_description\n FROM zzzzsys_form LIMIT 0, 39', '', '2017-01-05 11:23:49'),
('586d991fd3d19ff', 'SELECT zzzzsys_object_id,sob_all_fast_form_description,sob_all_id,sob_all_label,sob_all_type\n FROM zzzzsys_object\n WHERE sob_all_fast_form_description != '''' LIMIT 0, 210', '', '2017-01-05 11:23:51'),
('586d992947200d2', 'hello nuobjectbob', '', '2017-01-05 11:24:01'),
('586d9929bcc64ef', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id LIMIT 0, 209', '', '2017-01-05 11:24:01'),
('586d992a51b5ca8', 'hello nuobjectbob', '', '2017-01-05 11:24:02'),
('586d99349d34c60', 'hello nuobjectbob', '', '2017-01-05 11:24:12'),
('586d99352298058', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%nuhome%" OR sfo_description LIKE  "%nuhome%" OR syt_title LIKE  "%nuhome%" OR sob_all_label LIKE  "%nuhome%" OR zzzzsys_form_id LIKE  "%nuhome%" OR sob_all_id LIKE  "%nuhome%") ) LIMIT 0, 15', '', '2017-01-05 11:24:13'),
('586d9936decf57b', 'hello nuobjectbob', '', '2017-01-05 11:24:14'),
('586d9964e597037', 'nuHash : |run| Array\n(\n    [USER_ID] => globeadmin\n    [USER_GROUP_ID] => \n    [HOME_ID] => nuhome\n    [global_access] => 1\n    [record_id] => -1\n    [title] => Object\n    [call_type] => update\n    [filter] => \n    [iframe] => 0\n    [lookup_id] => \n    [object_id] => 1\n    [page_number] => 0\n    [password] => \n    [rows] => 25\n    [row_height] => 25\n    [search] => \n    [session_id] => 586d937183753bc\n    [sort] => -1\n    [sort_direction] => desc\n    [subforms] => 0\n    [username] => \n    [user_id] => globeadmin\n    [browse_rows] => \n    [pages] => 0\n    [deleteAll] => No\n    [nuobject] => -1\n    [FORM_ID] => nuobject\n    [PREVIOUS_RECORD_ID] => -1\n    [RECORD_ID] => -1\n    [sob_all_zzzzsys_tab_id] => 569dc4ed270f08a\n    [sob_all_type] => run\n    [sob_all_id] => calcobjects\n    [sob_all_label] => FORM\n    [sob_all_order] => 100\n    [sob_all_top] => 253\n    [sob_all_left] => 92\n    [sob_all_width] => 150\n    [sob_all_height] => 30\n    [sob_all_cloneable] => 1\n    [sob_all_align] => right\n    [sob_all_validate] => 1\n    [sob_all_readonly] => 0\n    [sob_all_display_condition] => \n    [sob_all_default_value_sql] => \n    [sob_all_zzzzsys_form_id] => nuhome\n    [sob_run_zzzzsys_form_id] => 585efbcfe4dfaf4\n    [sob_run_filter] => 585efbcfe4dfaf4\n    [sob_run_id] => \n    [sob_run_method] => b\n    [sob_display_sql] => \n    [sob_select_sql] => \n    [sob_select_multiple] => \n    [sob_lookup_zzzzsys_form_id] => \n    [sob_lookup_code] => \n    [sob_lookup_table] => \n    [sob_lookup_description] => \n    [sob_lookup_description_width] => \n    [sob_lookup_javascript] => \n    [sob_subform_zzzzsys_form_id] => \n    [sob_subform_foreign_key] => \n    [sob_subform_add] => \n    [sob_subform_delete] => \n    [sob_subform_type] => \n    [sob_input_type] => \n    [sob_input_format] => \n    [sob_html_code] => \n    [sob_all_fast_form_description] => aframe\n    [sob_calc_formula] => \n    [TABLE_ID] => ___nu1586d9964db571___\n    [SESSION_ID] => 586d937183753bc\n)\n', '', '2017-01-05 11:25:00'),
('586d9965148ee62', 'hello nuobjectbob', '', '2017-01-05 11:25:01'),
('586d996ac942a6e', 'SELECT thevalue,thevalue,thefilter,theform\n FROM ___nu1586d996a1d069___\n WHERE  ( (thevalue LIKE  "%585efbcfe4dfaf4%" OR thefilter LIKE  "%585efbcfe4dfaf4%" OR theform LIKE  "%585efbcfe4dfaf4%") ) LIMIT 0, 0', '', '2017-01-05 11:25:06'),
('586d997626045c0', 'hello nuobjectbob', '', '2017-01-05 11:25:18'),
('586d9976cbfb764', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id LIMIT 0, 210', '', '2017-01-05 11:25:18'),
('586d99776c685fc', 'hello nuobjectbob', '', '2017-01-05 11:25:19'),
('586d997dc044942', 'SELECT thevalue,thevalue,thefilter,theform\n FROM ___nu1586d997d34ad1___\n WHERE  ( (thevalue LIKE  "%585efbcfe4dfaf4%" OR thefilter LIKE  "%585efbcfe4dfaf4%" OR theform LIKE  "%585efbcfe4dfaf4%") ) LIMIT 0, 0', '', '2017-01-05 11:25:25'),
('586d99848818498', 'hello nuobjectbob', '', '2017-01-05 11:25:32'),
('586d998507544f4', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%nuhome%" OR sfo_description LIKE  "%nuhome%" OR syt_title LIKE  "%nuhome%" OR sob_all_label LIKE  "%nuhome%" OR zzzzsys_form_id LIKE  "%nuhome%" OR sob_all_id LIKE  "%nuhome%") ) LIMIT 0, 16', '', '2017-01-05 11:25:33'),
('586d9999759b347', 'hello nuobjectbob', '', '2017-01-05 11:25:53'),
('586d999a204811b', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%nuhome%" OR sfo_description LIKE  "%nuhome%" OR syt_title LIKE  "%nuhome%" OR sob_all_label LIKE  "%nuhome%" OR zzzzsys_form_id LIKE  "%nuhome%" OR sob_all_id LIKE  "%nuhome%") ) LIMIT 0, 16', '', '2017-01-05 11:25:54'),
('586d999ed98825c', 'hello nuobjectbob', '', '2017-01-05 11:25:58'),
('586d9c95267c30c', 'SELECT zzzzsys_form_id,sfo_type,sfo_code,sfo_description\n FROM zzzzsys_form\n ORDER BY sfo_code LIMIT 0, 39', '', '2017-01-05 11:38:37'),
('586d9dc05e2fa61', 'SELECT thevalue,thevalue,thefilter,theform\n FROM ___nu1586d9dbfcdbff___\n WHERE  ( (thevalue LIKE  "%585efbcfe4dfaf4%" OR thefilter LIKE  "%585efbcfe4dfaf4%" OR theform LIKE  "%585efbcfe4dfaf4%") ) LIMIT 0, 0', '', '2017-01-05 11:43:36'),
('586d9dc52d2bbe5', 'SELECT zzzzsys_form_id,sfo_code,sfo_description\n FROM zzzzsys_form LIMIT 0, 39', '', '2017-01-05 11:43:41'),
('586d9dc878227b1', 'SELECT zzzzsys_object_id,sob_all_fast_form_description,sob_all_id,sob_all_label,sob_all_type\n FROM zzzzsys_object\n WHERE sob_all_fast_form_description != '''' LIMIT 0, 211', '', '2017-01-05 11:43:44'),
('586d9dccef88760', 'SELECT zzzzsys_form_id,sfo_code,sfo_description\n FROM zzzzsys_form LIMIT 0, 39', '', '2017-01-05 11:43:48'),
('586d9dd1b71321e', 'hello nuobjectbob', '', '2017-01-05 11:43:53'),
('586d9dd23fe47e8', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id LIMIT 0, 210', '', '2017-01-05 11:43:54'),
('586d9dd2bb3c401', 'hello nuobjectbob', '', '2017-01-05 11:43:54'),
('586d9de317b5467', 'hello nuobjectbob', '', '2017-01-05 11:44:11'),
('586d9de38db5124', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id LIMIT 0, 210', '', '2017-01-05 11:44:11'),
('586d9de85507f5e', 'hello nuobjectbob', '', '2017-01-05 11:44:16'),
('586d9de8cb3c139', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%form%" OR sfo_description LIKE  "%form%" OR syt_title LIKE  "%form%" OR sob_all_label LIKE  "%form%" OR zzzzsys_form_id LIKE  "%form%" OR sob_all_id LIKE  "%form%") ) LIMIT 0, 101', '', '2017-01-05 11:44:16'),
('586d9ded7c643df', 'hello nuobjectbob', '', '2017-01-05 11:44:21'),
('586d9dedf305aae', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%form%" OR sfo_description LIKE  "%form%" OR syt_title LIKE  "%form%" OR sob_all_label LIKE  "%form%" OR zzzzsys_form_id LIKE  "%form%" OR sob_all_id LIKE  "%form%") ) \n ORDER BY sob_all_label asc LIMIT 0, 101', '', '2017-01-05 11:44:21'),
('586d9df3c568ffc', 'hello nuobjectbob', '', '2017-01-05 11:44:27'),
('586d9df4555019d', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%form%" OR sfo_description LIKE  "%form%" OR syt_title LIKE  "%form%" OR sob_all_label LIKE  "%form%" OR zzzzsys_form_id LIKE  "%form%" OR sob_all_id LIKE  "%form%") ) \n ORDER BY sob_all_label asc LIMIT 25, 101', '', '2017-01-05 11:44:28'),
('586d9df6763a843', 'hello nuobjectbob', '', '2017-01-05 11:44:30'),
('586d9df7195ab8f', 'SELECT zzzzsys_object_id,sob_all_type,sfo_description,syt_title,sob_all_label,zzzzsys_form_id,sob_all_id\n FROM zzzzsys_object JOIN zzzzsys_tab ON zzzzsys_tab_id = sob_all_zzzzsys_tab_id JOIN zzzzsys_form ON zzzzsys_form_id = syt_zzzzsys_form_id\n WHERE  ( (sob_all_type LIKE  "%form%" OR sfo_description LIKE  "%form%" OR syt_title LIKE  "%form%" OR sob_all_label LIKE  "%form%" OR zzzzsys_form_id LIKE  "%form%" OR sob_all_id LIKE  "%form%") ) \n ORDER BY sob_all_label asc LIMIT 50, 101', '', '2017-01-05 11:44:31');
...
('583362e1aebadc1', '570b1ad216682ef', 'onkeydown', 'nuLister(event, nuFORM.SQLFields($(''#sfo_browse_sql'').val() + '' ''))'),
('582ce6036518741', '570b1abae987b02', 'onkeydown', 'nuLister(event, nuFORM.SQLFields($(''#sfo_browse_sql'').val() + '' ''))'),
('583369c65550588', '570dabca9be44fd', 'onkeydown', 'nuLister(event, nuFORM.tableFields($(''#sob_lookup_table'').val()));'),
('583369e5667549f', '570dabf5a2e2b8f', 'onkeydown', 'nuLister(event, nuFORM.tableFields($(''#sob_lookup_table'').val()));'),
...
('585e5705f3e9867', 'nuobject', 'html', 'nucalculator', 'Operators', '5851cf915a1c653', 460, 200, 200, 200, 200, '', '1', 'right', '0', '1', '', '', 'sfo_javascript', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '\n<table>\n  <tr>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>+</td>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>-</td> \n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>*</td>\n  </tr>\n  <tr>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>/</td>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>(</td>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>)</td>\n  </tr>\n  <tr>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>?</td>\n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>:</td> \n    <td onclick=''nuAddToFormula(event)''  class=''nuCalculatorButton''>=</td> \n  </tr>\n</table>\n\n<script>\n\nfunction nuAddToFormula(e){\n	\n	var v	= $(''#sob_calc_formula'').val();\n	$(''#sob_calc_formula'').val(v + '' '' + e.target.innerHTML);\n	\n}\n\n</script>\n'),
('5851cfeb30f9047', 'nuobject', 'input', 'sob_calc_formula', 'Formula', '5851cf915a1c653', 460, 23, 69, 400, 40, '', '1', 'left', '0', '1', '', '', 'sfo_javascript', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
('586217b5a0772cd', 'nuhome', 'run', 'aframe2', 'FORM', '569dc4ed270f08a', 100, 253, 92, 150, 30, '', '1', 'right', '1', '0', '', '', 'aframe', '', '585efbcfe4dfaf4', '585efbcfe4dfaf4', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('586d9964e5ab10c', 'nuhome', 'run', 'calcobjects', 'FORM', '569dc4ed270f08a', 100, 253, 92, 150, 30, '', '1', 'right', '1', '0', '', '', 'aframe', '', '585efbcfe4dfaf4', '585efbcfe4dfaf4', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
('58649bac92f44f1', '2016-12-29 17:44:20', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('58649da8c79718e', '2016-12-29 17:52:48', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('5864a69f01f5e82', '2016-12-29 18:31:03', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('5864acc33edf15d', '2016-12-29 18:57:15', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d75418ef128b', '2017-01-05 10:50:49', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d7bf08e486fe', '2017-01-05 11:19:20', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d7bfdcac130b', '2017-01-05 11:19:33', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d7fd6b1f2d3b', '2017-01-05 11:35:58', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d81a1e65a885', '2017-01-05 11:43:37', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d83ae9eb6e2b', '2017-01-05 11:52:22', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d84320a3ae5b', '2017-01-05 11:54:34', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d8a6cad8235f', '2017-01-05 12:21:08', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d9063bf85129', '2017-01-05 12:46:35', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}'),
('586d937183753bc', '2017-01-05 12:59:37', '{"session":{"zzzzsys_user_group_id":"","zzzzsys_user_id":"globeadmin","sug_zzzzsys_form_id":"nuhome","global_access":"1"},"forms":["56773cb405f4913","5678ab2c48c5c41","568b508eec00d80","56c513162acd102","574665a15bbc1a1","5757a4b7181e365","57637ad7b560755","577b4d78ef9a2a0","57a29441f16c351","57a7c1cb78bf3a3","57edbac65e1c52a","583361606250b6e","58338c35b340428","583f372b53b972c","585efbcfe4dfaf4","nuaccess","nuaccessforms","nuaccessgroup","nuaccessreport","nublank","nubrowse","nubuildreport","nudebug","nuerror","nuevent","nuform","nuhome","nulaunchdates","nulookup","nunonsystemform","nuobject","nupassword","nuphp","nuphplibrary","nurunphp","nurunreport","nutab","nutimezone","nuuser"],"reports":["574b9845a681d27"],"procedures":["568b50020fc7a62_AB","574665a15bbc1a1_BO","57578be0057a49f","5757a4b7181e365_BB","57db70b7aa22cda","57f6e1f954955c1","581135daea4f878","585efbcfe4dfaf4_BB","nudebug_BD","nuform_AS","nuform_BS","nulaunchdates_BO","nuobject_BO","nuobject_BS","nupassword_BS","nuphp_AS","nuphp_BS","nuuser_AS"]}');
