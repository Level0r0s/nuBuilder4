...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2017 at 09:33 PM
...
('5864acd26e8ed78', 'hello Array\n(\n    [USER_ID] => globeadmin\n    [USER_GROUP_ID] => \n    [HOME_ID] => nuhome\n    [global_access] => 1\n    [PREVIOUS_RECORD_ID] => \n    [RECORD_ID] => \n    [FORM_ID] => 585efbcfe4dfaf4\n    [TABLE_ID] => ___nu15864acd26c05e___\n    [SESSION_ID] => 5864acc33edf15d\n)\n', '', '2016-12-29 16:57:30'),
('5864acd27cf4d9a', 'SSS SELECT thevalue,thevalue,thefilter\n FROM ___nu15864acd26c05e___\n WHERE  ( (thevalue LIKE  "%585efbcfe4dfaf4%" OR thefilter LIKE  "%585efbcfe4dfaf4%") )  LIMIT 0, 0', '', '2016-12-29 16:57:30'),
('5864ae672ca302f', 'hello Array\n(\n    [USER_ID] => globeadmin\n    [USER_GROUP_ID] => \n    [HOME_ID] => nuhome\n    [global_access] => 1\n    [PREVIOUS_RECORD_ID] => \n    [RECORD_ID] => \n    [FORM_ID] => 585efbcfe4dfaf4\n    [TABLE_ID] => ___nu15864ae672a320___\n    [SESSION_ID] => 5864acc33edf15d\n)\n', '', '2016-12-29 17:04:15');
...
--
-- Table structure for table `___nu15864a2a9ee26a___`
--

CREATE TABLE `___nu15864a2a9ee26a___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864a2a9ee26a___`
--

INSERT INTO `___nu15864a2a9ee26a___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
('FORM.emp_mobile', '5678ab2c48c5c41'),
('FORM.bus_code', '568b508eec00d80'),
('FORM.bus_description', '568b508eec00d80'),
('FORM.bus_check', '568b508eec00d80'),
('FORM.sfo_code', 'nuform'),
('FORM.sfo_description', 'nuform'),
('FORM.sfo_table', 'nuform'),
('FORM.sfo_primary_key', 'nuform'),
('FORM.sfo_row_height', 'nuform'),
('FORM.sfo_rows_per_page', 'nuform'),
('FORM.sfo_add_title', 'nuform'),
('FORM.sfo_print_title', 'nuform'),
('FORM.sbr_title', 'nubrowse'),
('FORM.sbr_display', 'nubrowse'),
('FORM.sbr_sort', 'nubrowse'),
('FORM.sbr_width', 'nubrowse'),
('FORM.sbr_order', 'nubrowse'),
('FORM.syt_title', 'nutab'),
('FORM.syt_order', 'nutab'),
('FORM.sfo_save_title', 'nuform'),
('FORM.sfo_clone_title', 'nuform'),
('FORM.sfo_delete_title', 'nuform'),
('FORM.sfo_new_title', 'nuform'),
('FORM.bb_event', 'nuform'),
('FORM.open_builder', 'nubuildreport'),
('FORM.sob_all_id', 'nuobject'),
('FORM.sob_all_label', 'nuobject'),
('FORM.sob_all_order', 'nuobject'),
('FORM.sob_all_top', 'nuobject'),
('FORM.sob_all_left', 'nuobject'),
('FORM.sob_all_width', 'nuobject'),
('FORM.sob_all_height', 'nuobject'),
('FORM.sob_subform_foreign_key', 'nuobject'),
('FORM.sob_run_filter', 'nuobject'),
('FORM.sob_run_id', 'nuobject'),
('FORM.sob_lookup_code', 'nuobject'),
('FORM.sob_lookup_description', 'nuobject'),
('FORM.sob_lookup_description_width', 'nuobject'),
('FORM.zzzzsys_slo_object_name', 'nulookup'),
('FORM.zzzzsys_slo_field_function_name', 'nulookup'),
('FORM.sev_event', 'nuevent'),
('FORM.sal_description', 'nuaccess'),
('FORM.sob_all_zzzzsys_form_id', 'nuobject'),
('FORM.sal_code', 'nuaccess'),
('FORM.sug_code', '574665a15bbc1a1'),
('FORM.sug_description', '574665a15bbc1a1'),
('FORM.sus_name', 'nuuser'),
('FORM.sus_email', 'nuuser'),
('FORM.sus_login_name', 'nuuser'),
('FORM.new_password', 'nuuser'),
('FORM.check_password', 'nuuser'),
('FORM.sph_code', 'nuphp'),
('FORM.sph_description', 'nuphp'),
('FORM.bla_html', 'nublank'),
('FORM.sre_code', 'nubuildreport'),
('FORM.sre_description', 'nubuildreport'),
('FORM.sre_group', 'nubuildreport'),
('FORM.steven', '577b4d78ef9a2a0'),
('FORM.com_address', '577b4d78ef9a2a0'),
('FORM.from_date', 'nulaunchdates'),
('FORM.to_date', 'nulaunchdates'),
('FORM.sph_group', 'nuphp'),
('FORM.set_time_out_minutes', '57a29441f16c351'),
('FORM.set_smtp_username', '57a29441f16c351'),
('FORM.set_smtp_password', '57a29441f16c351'),
('FORM.set_smtp_host', '57a29441f16c351'),
('FORM.set_smtp_from_address', '57a29441f16c351'),
('FORM.set_smtp_from_name', '57a29441f16c351'),
('FORM.set_smtp_port', '57a29441f16c351'),
('FORM.trl_language', '57a7c1cb78bf3a3'),
('FORM.trl_english', '57a7c1cb78bf3a3'),
('FORM.trl_translation', '57a7c1cb78bf3a3'),
('FORM.new_password_check', 'nupassword'),
('FORM.sob_all_fast_form_description', 'nuobject'),
('FORM.new_password', 'nupassword'),
('FORM.old_password', 'nupassword'),
('FORM.ab_event', 'nuobject'),
('FORM.error', 'nuerror'),
('FORM.bo_event', 'nuform'),
('FORM.bs_event', 'nuform'),
('FORM.as_event', 'nuform'),
('FORM.bd_event', 'nuform'),
('FORM.ad_event', 'nuform'),
('FORM.preiviewbtn', 'nuform'),
('FORM.sob_lookup_table', 'nuobject'),
('FORM.sob_all_id', '583f372b53b972c'),
('FORM.sob_all_label', '583f372b53b972c'),
('FORM.custom_id', '583f372b53b972c'),
('FORM.javascriptbtn', 'nuobject'),
('FORM.sob_calc_formula', 'nuobject'),
('employee_sf.emp_name', '56773cb405f4913'),
('employee_sf.emp_mobile', '56773cb405f4913'),
('zzzzsys_browse_sf.sbr_title', 'nuform'),
('zzzzsys_browse_sf.sbr_display', 'nuform'),
('zzzzsys_browse_sf.sbr_sort', 'nuform'),
('zzzzsys_browse_sf.sbr_width', 'nuform'),
('zzzzsys_browse_sf.sbr_order', 'nuform'),
('zzzzsys_tab_sf.syt_title', 'nuform'),
('zzzzsys_tab_sf.syt_order', 'nuform'),
('lookup_sf.zzzzsys_slo_object_name', 'nuobject'),
('lookup_sf.zzzzsys_slo_field_function_name', 'nuobject'),
('zzzzsys_event_sf.sev_event', 'nuobject'),
('obj_sf.sob_all_id', '583361606250b6e'),
('obj_sf.sob_all_label', '583361606250b6e'),
('obj_sf.custom_id', '583361606250b6e');

-- --------------------------------------------------------

--
-- Table structure for table `___nu15864a6a15f8a7___`
--

CREATE TABLE `___nu15864a6a15f8a7___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864a6a15f8a7___`
--

INSERT INTO `___nu15864a6a15f8a7___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu15864a73c1a936___`
--

CREATE TABLE `___nu15864a73c1a936___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864a73c1a936___`
--

INSERT INTO `___nu15864a73c1a936___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu15864a296771af___`
--

CREATE TABLE `___nu15864a296771af___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864a296771af___`
--

INSERT INTO `___nu15864a296771af___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu15864ab9c5c0ab___`
--

CREATE TABLE `___nu15864ab9c5c0ab___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864ab9c5c0ab___`
--

INSERT INTO `___nu15864ab9c5c0ab___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu15864ac644da0a___`
--

CREATE TABLE `___nu15864ac644da0a___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864ac644da0a___`
--

INSERT INTO `___nu15864ac644da0a___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu15864acd26c05e___`
--

CREATE TABLE `___nu15864acd26c05e___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864acd26c05e___`
--

INSERT INTO `___nu15864acd26c05e___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu15864ae672a320___`
--

CREATE TABLE `___nu15864ae672a320___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu15864ae672a320___`
--

INSERT INTO `___nu15864ae672a320___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu158649bea1febd___`
--

CREATE TABLE `___nu158649bea1febd___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu158649bea1febd___`
--

INSERT INTO `___nu158649bea1febd___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu158649c145ac87___`
--

CREATE TABLE `___nu158649c145ac87___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu158649c145ac87___`
--

INSERT INTO `___nu158649c145ac87___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu158649dabb7464___`
--

CREATE TABLE `___nu158649dabb7464___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu158649dabb7464___`
--

INSERT INTO `___nu158649dabb7464___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
...
--
-- Table structure for table `___nu158649dbdb5282___`
--

CREATE TABLE `___nu158649dbdb5282___` (
  `thevalue` text NOT NULL,
  `thefilter` varchar(300) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `___nu158649dbdb5282___`
--

INSERT INTO `___nu158649dbdb5282___` (`thevalue`, `thefilter`) VALUES
('FORM.com_name', '56773cb405f4913'),
('FORM.com_address', '56773cb405f4913'),
('FORM.com_suburb', '56773cb405f4913'),
('FORM.emp_name', '5678ab2c48c5c41'),
