...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2017 at 01:25 AM
...
('577c47fa66beb63', 'nurunreport', 'Form', 'sre_zzzzsys_form_id', 'l', '', 10, 0),
...
('577b4c18a8bf431', 'nurunphp', 'Description', 'sph_description', 'l', '', 30, 300),
('577b4c18a8c02ee', 'nurunphp', 'Group', 'sph_group', 'l', '', 40, 150),
('578726caa351b3e', 'nurunphp', 'PHP', 'sph_zzzzsys_form_id', 'l', '', 10, 0),
...
('58af6b019f64b46', 'nuformat', 'Type', 'srm_type', 'l', '', 20, 150),
('58af6b019f64f3a', 'nuformat', 'Format', 'srm_format', 'l', '', 10, 250),
...
('s14916342251167', 'nuform', 'Table', 'sfo_table', 'l', NULL, 40, 200),
...
('s14993014809861', 'nubuildtable', 'Description', 'description', 'l', '', 20, 300),
...
('s14993014809860', 'nubuildtable', 'Code', 'code', 'l', '', 10, 100),
...
('5999fbdf742814f', '5999fbb7b420615', 'onclick', 'nuGetBreadcrumb(0)'),
...
('s15029391059723', 's15028829289851', 'onchange', 'nuAddColumns()'),
('s15029391228794', 's15029319353711', 'onchange', 'nuAddColumns()'),
('s15029391500815', 's15028829289852', 'onchange', 'nuAddColumns()'),
('s15029391687971', 's15028829289853', 'onchange', 'nuAddColumns()'),
('s15029391817453', 's15028829289854', 'onchange', 'nuAddColumns()'),
('s15030377154402', 's15030377154400', 'onclick', 'nuPopPHP(event, ''BB'');');
...
('s15028831569399', 'launch', 'FR', 'Fast Report', '', '', '', 0, 0, 'SELECT * FROM Launch Form 0', '\n$(''#wrdaddable'').css({''font-size'' : 14, ''font-weight'' : 700, ''padding'' : 5}).addClass(''nuTabHolder'');\n$(''#ffwrd'').css({''font-size'' : 14, ''font-weight'' : 700, ''padding'' : 5}).addClass(''nuTabHolder'');\n$(''#list'')\n.addClass(''nuScroll'')\n.removeClass(''nuReadOnly'');\n\n\n\nfunction nuAddColumns(){\n\n    $(''#report_fields'').html('''');\n        \n    sf          = nuSubformObject(''subform'').rows;\n\n    for(var i = 0 ; i < sf.length ; i++){\n        \n        var l   = sf[i][1];\n        var w   = sf[i][4];\n        var c   = sf[i][5];\n        var a   = sf[i][3];\n        \n        if(l!='''' && w!='''' && a!=''''){\n            $(''#report_fields'').append(nuNewColumn(i, l, w, c, a));\n        }else{\n            debugger;\n        }\n        \n        \n    }\n    \n}\n\n\n\nfunction nuNewColumn(i, l, w, c, a){\n\n    var col = c==0?''#7cc242'':''#00adef'';\n    \n    var s = "<div id=''rf" + i + "'' style=''padding:5px 2px 5px 2px;display:inline-block;height:16px;font-size:12px;background-color:" + col + ";border:none;text-align:" + a + ";width:" + (w*3) + "px''>" + l + "</div> ";\n    \n    return s;\n\n}\n\n'),
('s15031377623888', 'subform', 'FF1', 'Fast Form 1', 'aa', 'aa_id', '', 0, 0, 'SELECT * FROM aa', ''),
('s15031379262010', 'subform', 'FF2', 'Fast Form 2', 'aaaaa', 'aaaaa_id', '', 0, 0, 'SELECT * FROM aaaaa', ''),
('s15031381414552', 'subform', 'FF3', 'Fast Form 3', 'aaa1', 'aaa1_id', '', 0, 0, 'SELECT * FROM aaa1', '');
...
('583387f044052c5', 'nuhome', '', 'run', 'fb_button', 'Fast Form', '581288bcd699493', 100, 35, 84, 150, 30, '1', 'center', '0', '0', '', '', '', 'nufflaunch', '', 'b', '-1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', ''),
...
('583f4ed643fcc3b', 'nufflaunch', 'zzzzsys_form', 'subform', 'obj_sf', ' ', '583361606251aef', 80, 105, 447, 500, 313, '1', 'right', '0', '0', '', '', '', 'nuffcustomobjects', '', 'i', '', '', '', '', '', '', '', '', '', '', '', 'zzzzsys_object', 'nuffobjects', 'zzzzsys_debug_id', '1', '1', 'g', '', 0, '', '', '', '', ''),
...
('s15025557047361', 's15024615056515', '', 'run', 'piframe', 'bottom', 's15025776952212', 40, 100, 100, 460, 233, '1', 'right', '1', '0', '', '', '', 's14919851858544', '', 'i', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
...
('s15024615056522', 's15024615056515', 'Launch Form', 'html', 'field02', ' ', 's15024615056516', 20, 192, 432, 229, 191, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''pie''></div>', ''),
('s15025780171500', 's15024615056515', '', 'run', 'riframe', 'bottom', 's15025776952214', 60, 100, 100, 460, 233, '1', 'right', '1', '0', '', '', '', '574b9845a681d27', '', 'i', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
('s15026741382074', 's15026741382071', '0', 'input', 'field00', 'text00', 's15026741382072', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15025591976718', 's15024615056515', '', 'run', 'pbutton', 'To Procedure', 's15025776952212', 50, 29, 213, 118, 30, '1', 'right', '1', '0', '', '', '', 's14919851858544', '', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
('s15025781182362', 's15024615056515', '', 'run', 'fiframe', 'bottom', 's15025776952216', 70, 100, 100, 460, 233, '1', 'right', '1', '0', '', '', '', 'nuaccess', '', 'i', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
('s15025833442273', 's15024615056515', 'Launch Form', 'html', 'bargraph', ' ', 's15024615056516', 30, 14, 428, 229, 191, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''bar''></div>', ''),
...
('s15028455226324', 'nuhome', '', 'run', 'run_fast_report', 'Fast Report', '581288bcd699493', 150, 35, 469, 150, 30, '1', 'left', '1', '0', '', '', '', 's15028831569399', '', 'b', '-1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
...
('s15028749829740', 's15028749829736', 'Launch Form 0', 'input', 'field00', 'text00', 's15028749829737', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
...
('s15028749829741', 's15028749829736', 'Launch Form 0', 'input', 'field01', 'text01', 's15028749829737', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
...
('s15028753504272', 's15028753504268', 'Launch Form 0', 'input', 'field00', 'text00', 's15028753504269', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028753504273', 's15028753504268', 'Launch Form 0', 'input', 'field01', 'text01', 's15028753504269', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028757804182', 's15028757804178', 'Launch Form 0', 'input', 'field00', 'text00', 's15028757804179', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028757804183', 's15028757804178', 'Launch Form 0', 'input', 'field01', 'text01', 's15028757804179', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028761380502', 's15028761380498', 'Launch Form 0', 'input', 'field00', 'text00', 's15028761380499', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028761380503', 's15028761380498', 'Launch Form 0', 'input', 'field01', 'text01', 's15028761380499', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028761878247', 's15028761878243', 'Launch Form 0', 'input', 'field00', 'text00', 's15028761878244', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028761878248', 's15028761878243', 'Launch Form 0', 'input', 'field01', 'text01', 's15028761878244', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15028829289851', 's15028829289845', 'invoice', 'input', 'fieldname', 'Field Name', 's15028829289846', 20, 50, 150, 230, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'nuScroll', 'String($(''#list'').val()).split("\\n")', '', ''),
('s15028829289852', 's15028829289845', 'invoice', 'select', 'align', 'Align', 's15028829289846', 30, 80, 180, 80, 16, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '0', 'left|Left|\nright|Right|\ncenter|Center', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', ''),
('s15028829289853', 's15028829289845', 'invoice', 'input', 'width', 'Width', 's15028829289846', 40, 110, 210, 60, 18, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'number', '', '', ''),
('s15028829289854', 's15028829289845', 'invoice', 'input', 'sum', 'Sum<br>Column', 's15028829289846', 50, 140, 240, 55, 18, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'checkbox', '', '', ''),
('s15028831569405', 's15028831569399', 'Launch Form 0', 'lookup', 'table', 'Table', 's15028831569400', 20, 77, 65, 80, 20, '1', 'left', '1', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', 'code', 'description', '178', '', 'nubuildtable', '\nif($(''#fieldlist'').val() != ''''){\n        \n    var e   = "var fl  = " + eval($(''#fieldlist'').val());\n    \n    eval(e);\n\n    $(''#list'').val(fl.join("\\n"));\n    \n}\n\n\n', '', 'zzzzsys_report_data', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'nuScroll', '[''North'',''South'',''East'',''West'']', '', ''),
('s15029744151077', 's15029744151073', 'Launch Form 0', 'input', 'field00', 'text00', 's15029744151074', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15029248391113', 's15028831569399', 'Launch Form 0', 'html', 'fieldwidths', ' ', 's15028831569400', 50, 338, 25, 1070, 26, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''report_fields'' style=''text-align:left;height:30px;border:none;''>\n    \n</div>', ''),
('s15029225871322', 's15028831569399', 'Launch Form 0', 'textarea', 'list', ' ', 's15028831569400', 30, 108, 25, 324, 203, '1', 'left', '0', '1', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''adiv'' style=''text-align:center;width:117px;border:1px solid red;'' class=''nuBreadcrumb''>\n    Hello World\n</div>', ''),
('s15028831569407', 's15028831569399', 'Launch Form 0', 'html', 'paperwidths', ' ', 's15028831569400', 60, 377, 25, 1070, 35, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''widthshtml'' style=''background-color:lightgrey;''>\n    \n    <div id=''nufld0'' style=''background-color:#BABABA;text-align:right;border:none;width:444px;''>A5 Portrait</div>\n    <div id=''nufld1'' style=''background-color:#BABABA;text-align:right;border:none;width:630px;''>A5 Landscape</div>\n    \n    <div id=''nufld2'' style=''background-color:#BABABA;text-align:right;border:none;width:630px;''>A4 Portrait</div>\n    <div id=''nufld3'' style=''background-color:#BABABA;text-align:right;border:none;width:648px;''>Letter Portrait</div>\n    <div id=''nufld4'' style=''background-color:#BABABA;text-align:right;border:none;width:648px;''>Legal Portrait</div>\n    \n    <div id=''nufld5'' style=''background-color:#BABABA;text-align:right;border:none;width:840px;''>Letter Landscape</div>\n    \n    <div id=''nufld6'' style=''background-color:#BABABA;text-align:right;border:none;width:891px;''>A4 Landscape</div>\n    <div id=''nufld7'' style=''background-color:#BABABA;text-align:right;border:none;width:1068px;''>Legal Landscape</div>\n    \n</div>\n\n', ''),
('s15028831569408', 's15028831569399', 'Launch Form 0', 'subform', 'subform', ' ', 's15028831569400', 80, 108, 381, 711, 203, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', 's15028829289845', 'trl_language', '1', '1', 'g', 'invoice', 89, 'N|$ 1,000.00', 'file', '', '', ''),
('s15030937901940', 's15030937901936', 'aaa', 'input', 'field00', 'text00', 's15030937901937', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15030937901941', 's15030937901936', 'aaa', 'input', 'field01', 'text01', 's15030937901937', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15029744151078', 's15029744151073', 'Launch Form 0', 'input', 'field01', 'text01', 's15029744151074', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15029332528955', 's15028831569399', 'Launch Form 0', 'input', 'fieldlist', 'list', 's15028831569400', 10, 0, 3, 400, 20, '1', 'left', '0', '2', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', 'code', 'description', '200', '', 'nubuildtable', '', '', 'zzzzsys_report_data', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'text', '[''North'',''South'',''East'',''West'']', '', ''),
('s15029319353711', 's15028829289845', 'invoice', 'input', 'fieldtitle', 'Field Title', 's15028829289846', 10, 50, 150, 230, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031374847480', 's15031374847475', 'aaaaaaa', 'input', 'field01', 'text01', 's15031374847476', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15030377154400', 's15028831569399', '', 'word', 'wrdaddable', 'Addable Objects', 's15028831569400', 40, 15, 25, 316, 20, '1', 'center', '0', '0', '', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', ''),
('s15030380714010', 's15028831569399', '', 'word', 'ffwrd', 'New Fast Report', 's15028831569400', 70, 15, 381, 711, 20, '1', 'center', '0', '0', '', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', ''),
('s15031374847479', 's15031374847475', 'aaaaaaa', 'input', 'field00', 'text00', 's15031374847476', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031373408372', 's15031373408368', 'aaa', 'input', 'field00', 'text00', 's15031373408369', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031373408373', 's15031373408368', 'aaa', 'input', 'field01', 'text01', 's15031373408369', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031373585205', 's15031373585201', 'aaa', 'input', 'field00', 'text00', 's15031373585202', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031373585206', 's15031373585201', 'aaa', 'input', 'field01', 'text01', 's15031373585202', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031375098009', 's15031375098005', 'aaaaaaa', 'input', 'field00', 'text00', 's15031375098006', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031375098010', 's15031375098005', 'aaaaaaa', 'input', 'field01', 'text01', 's15031375098006', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031377623892', 's15031377623888', 'aa', 'input', 'field00', 'text00', 's15031377623889', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031377623893', 's15031377623888', 'aa', 'input', 'field01', 'text01', 's15031377623889', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031379262014', 's15031379262010', 'aaaaa', 'input', 'field00', 'text00', 's15031379262011', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15031379262015', 's15031379262010', 'aaaaa', 'input', 'field01', 'text01', 's15031379262011', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('5999fadd671a157', '5999fadd5a72942', 'Launch Form 0', 'input', 'field00', 'text00', '5999fadd5b05825', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('5999fadd67d3da7', '5999fadd5a72942', 'Launch Form 0', 'input', 'field01', 'text01', '5999fadd5b05825', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('5999fbb7b420615', 'nuuserhome', '', 'input', 'rbacktohome', 'Sample User Form - Click to return to Home.', 's15003463994286', 10, 100, 100, 450, 116, '0', 'center', '0', '0', '', '', '', '5999fadd5a72942', '', 'b', '-1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', '');
...
('s14919851858544', 'HW', 'Hello World', 'test', '\nprint ''<br>Hello world!<br>'';', 'window', 'nublank', '', ''),
...
('s15028831569405_AB', 's15028831569405_AB', 'System PHP', 'nubuilder', '\n$i  =nuLookupRecord()->id;\n\n$tt	= nuTTList($i, ''nublank'');				//-- Field list from Temp table\n\nnudebug($i, $tt);\n\nnuSetFormValue(''fieldlist'', json_encode($tt));', '', '', '1', ''),
('s15029744151073_BE', 's15029744151073_BE', 'System PHP', 'nubuilder', '\n\n\nnudebug(1234);', '', '', '1', ''),
('nuaccessreport_BB', 'nuaccessreport_BB', 'System PHP', 'nubuilder', '', '', '', '1', ''),
('s15028831569399_BE', 's15028831569399_BE', 'System PHP', 'nubuilder', 'nudebug(9);', '', '', '1', '');
...
('s15028831569400', 's15028831569399', 'Main', 10),
('s15028479626853', 's15028479626852', 'Main', 10),
('s15028479634761', 's15028479634760', 'Main', 10),
('s15028481482267', 's15028481482265', 'Main', 10),
('s15031381414553', 's15031381414552', 'Main', 10),
('s15031377623889', 's15031377623888', 'Main', 10),
('s15031379262011', 's15031379262010', 'Main', 10);
