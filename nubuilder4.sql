...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2017 at 10:27 PM
...
('58b0fd08765d744', '58aff3b26918933', 'onchange', 'nuBuildFormat();'),
('58b100b1a94fb82', '58aff4d0011ed8d', 'onchange', 'nuBuildFormat();'),
('58b100d063edb19', '58aff48f678f587', 'onchange', 'nuBuildFormat();'),
('58b104c96343ab4', '58b0c669738053e', 'onchange', 'nuBuildFormat();'),
...
('58af6b019f63c7e', 'browseedit', 'FMT', 'Input Formats', 'zzzzsys_format', 'zzzzsys_format_id', '', '', '', '', 'SELECT * FROM zzzzsys_format', '1', '', '', '', '', '', '1', '', '', '1', '', '', '1', '', '', '', '', '', '', '', '', '', '', '$(''#srm_format'').addClass(''nuReadOnly'');\n$(''.nuWord'').css(''font-style'', ''bold'');\n\nnuSetFormatType();\n\n\nfunction nuFormatSample(m){\n\n    var a   = [];\n    \n    a.push(['' '', '' '']);\n    a.push(['','', '','']);\n    a.push([''.'', ''.'']);\n    a.push([''/'', ''/'']);\n    a.push([''-'', ''-'']);\n    a.push(['':'', '':'']);\n    a.push([''WWW'', ''Fri'']);\n    a.push([''WWWW'', ''Friday'']);\n    a.push([''w'', ''6'']);\n    a.push([''MMM'', ''Jan'']);\n    a.push([''MMMM'', ''January'']);\n    a.push([''mm'', ''01'']);\n    a.push([''m'', ''1'']);\n    a.push([''dd'', ''13'']);\n    a.push([''d'', ''13'']);\n    a.push([''yyyy'', ''2007'']);\n    a.push([''yy'', ''07'']);\n    a.push([''y'', ''7'']);\n    a.push([''th'', ''10'']);\n    a.push([''tm'', ''30'']);\n    a.push([''ts'', ''00'']);\n\n    for(var i = 0 ; i < a.length ; i++){\n        \n        if(a[i][0] == m){\n            return a[i][1];\n        }\n        \n    }\n\n\n    return '''';\n    \n}\n\nfunction nuBuildFormat(){\n    \n    if($(''#srm_type'').val() == ''Date''){\n\n        var f   = $(''#srm_format'').val();\n        var d   = $(''#date_format'').val();\n\n        $(''#srm_format'').val(f + d).addClass(''nuEdited'');\n\n    }\n    \n    if($(''#srm_type'').val() == ''Number''){\n        \n        var s   = String($(''#sign'').val()).trim();\n        var d   = $(''#decimals'').val();\n        var f   = $(''#number_format'').val();\n        var m   = (d == 0 ? f.substr(0, f.length - 1) : f);\n\n        if(parseInt(d) == 0){\n            $(''#srm_format'').val(s + '' '' + f).addClass(''nuEdited'');\n        }else{\n            $(''#srm_format'').val(s + '' '' + f + String(''0'').repeat(d)).addClass(''nuEdited'');\n        }\n\n    }\n    \n}\n\n\nfunction nuSetFormatType(a){\n    \n    nuHide(''sign'');\n    nuHide(''number_format'');\n    nuHide(''decimals'');\n    nuHide(''date_format'');\n    nuHide(''add_number'');\n    nuHide(''add_date'');\n\n    if(arguments.length == 1){\n        $(''#srm_format'').val('''');\n    }\n    \n    if($(''#srm_type'').val() == ''Date''){\n        nuShow(''date_format'');\n    }\n    \n    if($(''#srm_type'').val() == ''Number''){\n        \n        nuShow(''sign'');\n        nuShow(''number_format'');\n        nuShow(''decimals'');\n\n    }\n    \n}\n\n\n\n');
...
('581666d5c06c0f8', 'nuform', 'zzzzsys_form', 'word', 'displayconditionwrd2', 'Display Condition', '5707303141ab448', 150, 12, 409, 200, 18, '', '1', 'left', '0', '0', '', '', 'displayconditionwrd2', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('5816672a8a12ea9', 'nuform', 'zzzzsys_form', 'word', 'titlewrd2', 'Title', '5707303141ab448', 160, 12, 202, 111, 18, '', '1', 'center', '0', '0', '', '', 'titlewrd2', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
('58aff2b35cd9963', '58af6b019f63c7e', 'zzzzsys_format', 'select', 'srm_type', 'Input Type', '58af6b019f658f4', 10, 34, 100, 100, 18, '', '1', 'left', '1', '0', '', '', 'sob_input_type', '', '', '', '', '', '', '', '0', 'Number|Number|\nDate|Date', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', '', 'text', '', ''),
('58aff3b26918933', '58af6b019f63c7e', 'zzzzsys_form', 'select', 'number_format', 'Format', '58af6b019f658f4', 50, 135, 211, 100, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', '0', '1000.|1000.|1,000.|1,000.|1000,|1000,|1.000,|1.000,', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58b051c8e440efe', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'srm_format', ' ', '58af6b019f658f4', 20, 34, 220, 210, 18, '', '0', 'left', '0', '1', '', '', 'sfo_description', '', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58aff48f678f587', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'decimals', 'Decimal Places', '58af6b019f658f4', 60, 135, 417, 50, 18, '', '0', 'right', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'number', '', ''),
('58aff4d0011ed8d', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'sign', 'Sign', '58af6b019f658f4', 30, 135, 100, 50, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'nuScroll', '[''$'', ''£'', ''€'', ''¢'']', ''),
('58b3ba63710b5aa', '58af6b019f63c7e', 'zzzzsys_form', 'calc', 'test', ' Test', '58af6b019f658f4', 20, 334, 220, 210, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', 'N|$ 1,000.00', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58b0c669738053e', '58af6b019f63c7e', 'zzzzsys_form', 'select', 'date_format', 'Date Formats', '58af6b019f658f4', 70, 135, 100, 210, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', '0', ' | ( )|.|. (.)|/|/ (/)|-| - (-)|:| (:)|WWW|WWW (Fri)|WWWW|WWWW (Friday) |w|w (6)|MMM|MMM (Jan)|MMMM|MMMM (January)|mm|mm (01)|m|m (1)|dd|dd (13)|d|d (13)|yyyy|yyyy (2007)|yy|yy (07)|y|y (7)|th|th (10)|tm|tm (30)|ts|ts (00)', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
('58b34691918e917', '58af6b019f63c7e', 'zzzzsys_form', 'word', 'format_title', 'Format Builder', '58af6b019f658f4', 40, 103, 100, 347, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'nuScroll', '[''$'', ''£'', ''€'']', ''),
