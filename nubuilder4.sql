...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2017 at 12:37 AM
...
('58bf0b972c2ae9c', '58bf0b972c2a447', 'thenumber1<p>wrtgbegh', 'number1', 'l', 'N|$ 1,000.00', 10, 150),
...
('573d15d41e279ba', 'nubuildreport', 'zzzzsys_report', 'input', 'open_designer', 'Report Designer', '574b964941d3d1a', 60, 181, 236, 100, 18, '1', 'center', '0', '0', '', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', ''),
...
('s14967319482165', '58a08a1abc4782c', 'invoice', 'lookup', 'inv_company_id', 'Customer', '58a08a1abc48c9a', 70, 32, 211, 50, 20, '1', 'right', '0', '0', '', '', '', '', '', '', '', '', '', '', 'com_code', 'com_name', '200', '', 's14967315763149', '', '', 'company', '', '', '', '', '', '', 0, '', 'nuDate', '', '', ''),
...
('s15007825589090', 's15007825589086', 'aaaaaa', 'input', 'field00', 'text00', 's15007825589087', 50, 50, 50, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15007825589091', 's15007825589086', 'aaaaaa', 'input', 'field01', 'text01', 's15007825589087', 80, 80, 80, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15007827397785', 's15007827397781', 'aaaaa', 'input', 'field00', 'text00', 's15007827397782', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15007827397786', 's15007827397781', 'aaaaa', 'input', 'field01', 'text01', 's15007827397782', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15007828975046', 's15007828975042', 'aaaaaaaaaa', 'input', 'field00', 'text00', 's15007828975043', 50, 50, 150, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', ''),
('s15007828975047', 's15007828975042', 'aaaaaaaaaa', 'input', 'field01', 'text01', 's15007828975043', 80, 80, 180, 117, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'text', '', '', '');
...
('s15010125739324', 'SYSUSE', 'Update db from sys_zzzzsys tables', 'nubuilder', '\n$tbl[]    = \'zzzzsys_access_level\';\n$tbl[]    = \'zzzzsys_access_level_form\';\n$tbl[]    = \'zzzzsys_access_level_php\';\n$tbl[]    = \'zzzzsys_access_level_report\';\n$tbl[]    = \'zzzzsys_browse\';\n$tbl[]    = \'zzzzsys_debug\';\n$tbl[]    = \'zzzzsys_event\';\n$tbl[]    = \'zzzzsys_file\';\n$tbl[]    = \'zzzzsys_form\';\n$tbl[]    = \'zzzzsys_format\';\n$tbl[]    = \'zzzzsys_function\';\n$tbl[]    = \'zzzzsys_object\';\n$tbl[]    = \'zzzzsys_php\';\n$tbl[]    = \'zzzzsys_php_library\';\n$tbl[]    = \'zzzzsys_report\';\n$tbl[]    = \'zzzzsys_report_data\';\n$tbl[]    = \'zzzzsys_run_list\';\n$tbl[]    = \'zzzzsys_select\';\n$tbl[]    = \'zzzzsys_select_clause\';\n$tbl[]    = \'zzzzsys_session\';\n$tbl[]    = \'zzzzsys_setup\';\n$tbl[]    = \'zzzzsys_tab\';\n$tbl[]    = \'zzzzsys_timezone\';\n$tbl[]    = \'zzzzsys_translate\';\n$tbl[]    = \'zzzzsys_user\';\n\n\n\nfor($i = 0 ; $i < count($tbl) ; $i++){\n    \n    $tn     = $tbl[$i];\n    \n    $sn     = db_field_names(\'sys_\' . $tn);\n    $st     = db_field_types(\'sys_\' . $tn);\n    \n    $zn     = db_field_names($tn);\n    $zt     = db_field_types($tn);\n    \n    $sj     = json_encode(array(\'name\' => $sn, \'type\' => $st));\n    $zj     = json_encode(array(\'name\' => $zn, \'type\' => $zt));\n    \n    if($sj != $zj){\n        nuFixStructure($tn, $sj, $zj);\n    }\n    \n}\n\n\n\n\n//-- REMOVE FORM with ids that start with \'nu\'\n\n$s  = \"CREATE TABLE old_forms SELECT zzzzsys_form_id FROM zzzzsys_form         WHERE zzzzsys_form_id LIKE \'nu%\'\";\nnuRunQuery($s);\n\n$s  = \"CREATE TABLE old_tabs SELECT zzzzsys_tab_id FROM zzzzsys_tab            WHERE syt_zzzzsys_form_id LIKE \'nu%\'\";\nnuRunQuery($s);\n\n$s  = \"CREATE TABLE old_objects SELECT zzzzsys_object_id FROM zzzzsys_object   WHERE sob_all_zzzzsys_form_id LIKE \'nu%\'\";\nnuRunQuery($s);\n\n$s  = \"DELETE FROM zzzzsys_form                                                WHERE zzzzsys_form_id LIKE \'nu%\'\";\nnuRunQuery($s);\n\n$s  = \"DELETE FROM zzzzsys_tab                                                 WHERE syt_zzzzsys_form_id LIKE \'nu%\'\";\nnuRunQuery($s);\n\n$s  = \"DELETE FROM zzzzsys_object                                              WHERE sob_all_zzzzsys_form_id LIKE \'nu%\'\";\nnuRunQuery($s);\n\n$t  = nuRunQuery(\'SELECT * FROM old_forms\');\nwhile($r = db_fetch_object($t)){\n    nuRunQuery(\"DELETE FROM zzzzsys_php WHERE zzzzsys_php_id LIKE \'$r->zzzzsys_form_id%\");\n    nuRunQuery(\"DELETE FROM zzzzsys_php_library WHERE spl_zzzzsys_php_id LIKE \'$r->zzzzsys_form_id%\");\n}\n\n$t  = nuRunQuery(\'SELECT * FROM old_objects\');\nwhile($r = db_fetch_object($t)){\n    nuRunQuery(\"DELETE FROM zzzzsys_php WHERE zzzzsys_php_id LIKE \'$r->zzzzsys_object_id%\");\n    nuRunQuery(\"DELETE FROM zzzzsys_php_library WHERE spl_zzzzsys_php_id LIKE \'$r->zzzzsys_object_id%\");\n}\n\n\n$s  =  \"DELETE FROM sys_zzzzsys_browse WHERE sbr_zzzzsys_form_id NOT IN (SELECT zzzzsys_form_id FROM old_forms)\";\nnuRunQuery($s);\n\n\n//-- KEEP EVENTs, from OBJECTs, from FORMs with ids that start with \'nu\'\n\n$s  =  \"DELETE FROM sys_zzzzsys_event WHERE sev_zzzzsys_object_id NOT IN (SELECT zzzzsys_object_id FROM old_objects)\";\nnuRunQuery($s);\n\n\nfor($i = 0 ; $i < count($tbl) ; $i++){\n    \n    $table  = $tbl[$i];\n    \n    nuRunQuery(\"INSERT INTO $table SELECT * FROM sys_$table\");\n\n}\n\n\n\n\n\n\n\n\n\n\n\nfunction nuFixStructure($t, $s, $z){\n    \n    $S      = json_decode($s);\n    $Z      = json_decode($z);\n\n    for($i = 0 ; $i < count($S->name) ; $i++){\n        \n        $name   = $S->name[$i];\n        $type   = $S->type[$i];\n        \n        if(in_array($S->name[$i], $Z->name)){\n            \n            if($S->type[$i] != $Z->type[$i]){\n                nuRunQuery(\"ALTER TABLE $t ALTER $name $type\");\n            }\n            \n        }else{\n            nuRunQuery(\"ALTER TABLE $t ADD $name $type\");\n        }\n\n    }\n\n    $last   = \'\';\n    \n    for($i = 0 ; $i < count($S->name) ; $i++){\n        \n        $name   = $S->name[$i];\n        $type   = $S->type[$i];\n\n        if($last == \'\'){\n            nuRunQuery(\"ALTER TABLE $t MODIFY $name $type FIRST\");\n        }else{\n            nuRunQuery(\"ALTER TABLE $t MODIFY $name $type AFTER $last\");\n        }\n        \n        $last   = $S->name[$i];\n\n    }\n\n}\n\n\n\n\nprint \'Done!\';\n\n\n\n', 'window', 'nublank', '', '');
...
('s15009287491957', 'U', 'User', 'test', 's15009286510041', '', '{\"top\":30,\"left\":30,\"bottom\":260,\"right\":30,\"width\":210,\"height\":297,\"paper\":\"A4\",\"orientation\":\"P\",\"groups\":[{\"sortField\":\"Detail\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":79,\"label\":\"Detail Header\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[{\"id\":\"obj1001\",\"objectType\":\"field\",\"backgroundColor\":\"white\",\"borderColor\":\"black\",\"borderWidth\":\"0\",\"fieldName\":\"sus_name\",\"fontColor\":\"black\",\"fontFamily\":\"Arial\",\"fontSize\":\"10\",\"fontWeight\":\"\",\"format\":\"\",\"textAlign\":\"left\",\"image\":\"\",\"group\":0,\"section\":0,\"left\":128,\"top\":11,\"height\":20,\"width\":100,\"zIndex\":124,\"minRows\":0,\"maxRows\":0,\"selected\":0,\"name\":\"obj1001\"},{\"id\":\"obj1002\",\"objectType\":\"field\",\"backgroundColor\":\"white\",\"borderColor\":\"black\",\"borderWidth\":\"0\",\"fieldName\":\"sus_login_name\",\"fontColor\":\"black\",\"fontFamily\":\"Arial\",\"fontSize\":\"10\",\"fontWeight\":\"\",\"format\":\"\",\"textAlign\":\"left\",\"image\":\"\",\"group\":0,\"section\":0,\"left\":126,\"top\":45,\"height\":20,\"width\":100,\"zIndex\":124,\"minRows\":0,\"maxRows\":0,\"selected\":0,\"name\":\"obj1002\"}]}]},{\"sortField\":\"Report\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":30,\"height\":41,\"label\":\"Report Header\",\"page_break\":0,\"margins\":2,\"color\":\"#FFFFFF\",\"objects\":[{\"id\":\"obj1003\",\"objectType\":\"field\",\"backgroundColor\":\"white\",\"borderColor\":\"black\",\"borderWidth\":\"0\",\"fieldName\":\"#description#\",\"fontColor\":\"black\",\"fontFamily\":\"Arial\",\"fontSize\":\"10\",\"fontWeight\":\"\",\"format\":\"\",\"textAlign\":\"left\",\"image\":\"\",\"group\":0,\"section\":0,\"left\":100,\"top\":11,\"height\":20,\"width\":100,\"zIndex\":124,\"minRows\":0,\"maxRows\":0,\"selected\":0,\"name\":\"obj1003\"}]},{\"id\":\"\",\"top\":190,\"height\":40,\"label\":\"Report Footer\",\"page_break\":0,\"margins\":10,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"Page\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":70,\"height\":40,\"label\":\"Page Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":40,\"label\":\"Page Footer\",\"page_break\":0,\"margins\":8,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]},{\"sortField\":\"\",\"sortBy\":\"a\",\"sections\":[{\"id\":\"\",\"top\":110,\"height\":0,\"label\":\" Header\",\"page_break\":0,\"margins\":4,\"color\":\"#FFFFFF\",\"objects\":[]},{\"id\":\"\",\"top\":150,\"height\":0,\"label\":\" Footer\",\"page_break\":0,\"margins\":6,\"color\":\"#FFFFFF\",\"objects\":[]}]}],\"currentGroup\":0,\"selected\":[\"obj1003\"],\"setFocus\":\"fieldName\"}');
...
('58d3719f55819e7_BR', '', '{\"tables\":[{\"id\":\"boxc15007494122195907\",\"position\":{\"top\":28,\"left\":68},\"tablename\":\"invoice\",\"alias\":\"\",\"checkall\":true,\"checkboxes\":[false,false,false,false,false]},{\"id\":\"boxc15007494144745908\",\"position\":{\"top\":40,\"left\":400},\"tablename\":\"invoice_item\",\"alias\":\"\",\"checkall\":true,\"checkboxes\":[false,false,false,false,false,false]}],\"joins\":{\"field_0_boxc15007494122195907--field_1_boxc15007494144745908\":\"\"}}', 'SELECT\n    invoice.*,\n    invoice_item.*\n\nFROM\n    invoice\n        JOIN invoice ON invoice.invoice_id = invoice_item.ite_invoice_id\n', 0, '1'),
('s15009286510041', 'A User', '{\"tables\":[{\"id\":\"boxc15009285736898687\",\"position\":{\"top\":25,\"left\":22},\"tablename\":\"zzzzsys_user\",\"alias\":\"\",\"checkall\":true,\"checkboxes\":[false,false,false,false,false,false,false,false]}],\"joins\":{}}', 'SELECT\n    zzzzsys_user.*\n\nFROM\n    zzzzsys_user\n\nWHERE\n    (zzzzsys_user.zzzzsys_user_id\\\'#RECORD_ID#\\\')\n\n', 50, '');
...
('s15009286510042', 's15009286510041', '1', 'zzzzsys_user.zzzzsys_user_id', '\\\'#RECORD_ID#\\\'', '', '');
