...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2017 at 02:42 AM
...
('s14993014809858', 'browse', 'PANDS', 'PHP and SELECT ', 'zzzzsys_report_data', 'id', '', 0, 0, 'SELECT * FROM zzzzsys_report_data', '');
...
('573d15d41e279ba', 'nubuildreport', 'zzzzsys_report', 'input', 'open_builder', 'Design Report', '574b964941d3d1a', 60, 181, 236, 100, 21, '1', 'center', '0', '0', '', '', '', '', '', '', '', '', '0', '0|No|1|Yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'button', '', '', ''),
...
('s14990193555021', 'INV', 'Invoice', 'test', 's14966166430334', 'nublank', ''),
