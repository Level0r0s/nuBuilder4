...
--
-- Host: localhost
-- Generation Time: Jul 27, 2016 at 01:39 AM
...
('577b4228b34a55d', 'nurunreport', 'Code', 'sre_code', 'l', '', 'sre_code', 30, 150),
('577b4228b34af41', 'nurunreport', 'Description', 'sre_description', 'l', '', 'sre_description', 40, 250),
('577b4228b34b950', 'nurunreport', 'Group', 'sre_group', 'l', '', 'sre_group', 50, 150),
...
('577b4b6ca3ea898', 'nurunphp', 'Code', 'sph_code', 'l', NULL, 'sph_code', 30, 150),
('577b4c18a8bf431', 'nurunphp', 'Description', 'sph_description', NULL, NULL, 'sph_description', 40, 300),
('577b4c18a8c02ee', 'nurunphp', 'Group', 'sph_group', NULL, NULL, 'sph_group', 50, 150),
('578726caa351b3e', 'nurunphp', 'PHP', 'sph_zzzzsys_form_id', NULL, NULL, 'sph_zzzzsys_form_id', 10, 1),
('5796b262044f91d', 'nurunreport', 'r', '''pdf''', NULL, NULL, '''pdf''', 20, 1),
('579006cac02b9f3', 'nuphp', 'Launch By', 'CONCAT(sfo_code, '' - '', sfo_description)', 'l', NULL, 'sfo_code', 40, 300),
('5796b33c6866c3d', 'nurunphp', 'p', '''php''', NULL, NULL, '''php''', 20, 1);
...
('nulaunchdates', 'launch', '2DATES', 'Between 2 Dates', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'debugger;\nvar reportID    = nuBC[nuBC.length-1].record_id;\nnuAppendActionButton(''Run Procedure'',"nuRunPHP(''" + reportID + "'');");\nnuAppendActionButton(''Email'',"nuEmailPHP(''" + reportID + "'');");\n\n');
...
('57578be0057a49f', 'HELLOW', 'Hello World', 'test', 'print ''hello #TABLE_ID# world'';', '5678ab2c48c5c41', 'nulaunchdates');
