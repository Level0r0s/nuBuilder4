...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2017 at 05:18 AM
...
('58af6b019f645f3', '58af6b019f63c7e', 'Description', 'srm_description', NULL, NULL, 'srm_description', 10, 150),
('58af6b019f64b46', '58af6b019f63c7e', 'Type', 'srm_type', NULL, NULL, 'srm_type', 20, 100),
('58af6b019f64f3a', '58af6b019f63c7e', 'Format', 'smr_format', NULL, NULL, 'smr_format', 30, 100);
...
('58b0d4a60b9c172', '58aff2b35cd9963', 'onchange', 'nuSetFormatType()'),
('58b0e4f041b8d68', '58b0c9c3b4fab45', 'onclick', 'nuBuildFormat();'),
('58b0f27e36d1f16', '58b0f27e36d0f0c', 'onclick', 'nuBuildFormat();'),
...
('58af6b019f63c7e', 'browseedit', 'FMT', 'Input Formats', 'zzzzsys_format', 'zzzzsys_format_id', '', '', '', '', 'SELECT * FROM zzzzsys_format', '1', '', '', '', '', '', '1', '', '', '1', '', '', '1', '', '', '', '', '', '', '', '', '', '', '$(''#srm_format'').addClass(''nuReadOnly'');\n$(''#srm_sample'').addClass(''nuReadOnly'');\n\nnuSetFormatType();\n\n\nfunction nuFormatSample(m){\n\n    var a   = [];\n    \n    a.push(['' '', '' '']);\n    a.push(['','', '','']);\n    a.push([''.'', ''.'']);\n    a.push([''/'', ''/'']);\n    a.push([''-'', ''-'']);\n    a.push(['':'', '':'']);\n    a.push([''WWW'', ''Fri'']);\n    a.push([''WWWW'', ''Friday'']);\n    a.push([''w'', ''6'']);\n    a.push([''MMM'', ''Jan'']);\n    a.push([''MMMM'', ''January'']);\n    a.push([''mm'', ''01'']);\n    a.push([''m'', ''1'']);\n    a.push([''dd'', ''13'']);\n    a.push([''d'', ''13'']);\n    a.push([''yyyy'', ''2007'']);\n    a.push([''yy'', ''07'']);\n    a.push([''y'', ''7'']);\n    a.push([''th'', ''10'']);\n    a.push([''tm'', ''30'']);\n    a.push([''ts'', ''00'']);\n    a.push([''0'', '''']);\n    a.push([''1'', ''0'']);\n    a.push([''2'', ''00'']);\n    a.push([''3'', ''000'']);\n    a.push([''4'', ''0000'']);\n    a.push([''5'', ''00000'']);\n    a.push([''6'', ''000000'']);\n    a.push([''7'', ''0000000'']);\n    a.push([''[,.]'',   ''1,000.'']);\n    a.push([''[.]'',    ''1000.'']);\n    a.push([''[.,]'',   ''1.000,'']);\n    a.push([''[,]'',   ''1000,'']);\n\n    for(var i = 0 ; i < a.length ; i++){\n        \n        if(a[i][0] == m){\n            return a[i][1];\n        }\n        \n    }\n\n\n    return '''';\n    \n}\n\n\n\n\n\nfunction nuBuildFormat(){\n    \n    if($(''#srm_type'').val() == ''Date''){\n\n        var f   = $(''#srm_format'').val();\n        var s   = $(''#srm_sample'').val();\n        var d   = $(''#date_format'').val();\n\n        $(''#srm_format'').val(f + d);\n        $(''#srm_sample'').val(s + nuFormatSample(d));\n        \n    }\n    \n    if($(''#srm_type'').val() == ''Number''){\n        \n        var s   = $(''#sign'').val();\n        var d   = $(''#decimals'').val();\n        var f   = String($(''#number_format'').val());\n        var m   = (d == 0 ? f.substr(0, f.length - 1) : f);\n        \n        $(''#srm_format'').val(s + f + d);\n        \n        if(parseInt(d) == 0){\n            $(''#srm_sample'').val(s + nuFormatSample(f));\n        }else{\n            $(''#srm_sample'').val(s + nuFormatSample(f) + String(''0'').repeat(d));\n        }\n\n    }\n    \n}\n\n\nfunction nuSetFormatType(){\n    \n    $(''#srm_format'').val('''');\n    $(''#srm_sample'').val('''');\n\n    nuDisable(''sign'');\n    nuDisable(''number_format'');\n    nuDisable(''decimals'');\n    nuDisable(''date_format'');\n    nuDisable(''add_number'');\n    nuDisable(''add_date'');\n\n    if($(''#srm_type'').val() == ''Date''){\n        \n        nuDisable(''sign'');\n        nuDisable(''number_format'');\n        nuDisable(''decimals'');\n        nuEnable(''date_format'');\n        nuDisable(''add_number'');\n        nuEnable(''add_date'');\n\n    }\n    \n    if($(''#srm_type'').val() == ''Number''){\n        \n        nuEnable(''sign'');\n        nuEnable(''number_format'');\n        nuEnable(''decimals'');\n        nuDisable(''date_format'');\n        nuEnable(''add_number'');\n        nuDisable(''add_date'');\n\n    }\n    \n}\n\n\n\n');
...
CREATE TABLE `zzzzsys_format` (
  ...
  `srm_description` varchar(300) NOT NULL,
  `srm_format` varchar(20) NOT NULL,
  `srm_sign` varchar(10) NOT NULL,
  `srm_sample` varchar(300) NOT NULL,
  `src_number_format` varchar(2) NOT NULL,
  `srm_decimal_places` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `zzzzsys_format` (`zzzzsys_format_id`, `srm_type`, `srm_description`, `srm_format`, `srm_sign`, `srm_sample`, `src_number_format`, `srm_decimal_places`) VALUES
('58b1054e651f494', 'Date', '', 'yyyy-mm-dd', '', '2007-01-13', '', 0);
...
('58a680c21664405', 'nuobject', 'zzzzsys_object', 'input', 'sob_all_table', 'Table', '570d90df5ce8e1a', 170, 0, 100, 100, 18, '', '1', 'left', '0', '1', 'SELECT ''0''', '', 'sob_all_zzzzsys_form_id', '', '', '', '', '', '', '', '', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', '', '', ''),
('58afef1eacbcf15', 'nuhome', '', 'run', 'run_format', 'Formats', '569dc4ed270f08a', 140, 400, 622, 150, 30, '', '1', 'left', '1', '0', '', '', 'run_debug', '', '58af6b019f63c7e', '', 'b', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58aff2b35cd9963', '58af6b019f63c7e', 'zzzzsys_format', 'select', 'srm_type', 'Input Type', '58af6b019f658f4', 10, 50, 100, 100, 18, '', '1', 'left', '1', '0', '', '', 'sob_input_type', '', '', '', '', '', '', '0', 'Number|Number|\nDate|Date', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', '', 'text', ''),
('58aff3b26918933', '58af6b019f63c7e', 'zzzzsys_form', 'select', 'number_format', 'Format', '58af6b019f658f4', 60, 193, 211, 100, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '0', '[.]|1000.|[,.]|1,000.|[,]|1000,|[.,]|1.000,', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58b051c8e440efe', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'srm_format', 'Format', '58af6b019f658f4', 30, 106, 100, 350, 18, '', '0', 'left', '0', '1', '', '', 'sfo_description', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58aff48f678f587', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'decimals', 'Decimal Places', '58af6b019f658f4', 70, 193, 417, 30, 18, '', '0', 'right', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', 'number', ''),
('58aff4d0011ed8d', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'sign', 'Sign', '58af6b019f658f4', 50, 193, 100, 50, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58b0c9c3b4fab45', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'add_date', '+', '58af6b019f658f4', 90, 221, 473, 20, 18, '', '0', 'right', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', 'button', ''),
('58b0868186ed979', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'srm_sample', 'Sample', '58af6b019f658f4', 40, 134, 100, 350, 18, '', '0', 'left', '0', '1', '', '', 'sfo_description', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58b0c669738053e', '58af6b019f63c7e', 'zzzzsys_form', 'select', 'date_format', 'Date Formats', '58af6b019f658f4', 80, 221, 100, 210, 18, '', '0', 'left', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '0', ' | ( )|.|. (.)|/|/ (/)|-| - (-)|:| (:)|WWW|WWW (Fri)|WWWW|WWWW (Friday) |w|w (6)|MMM|MMM (Jan)|MMMM|MMMM (January)|mm|mm (01)|m|m (1)|dd|dd (13)|d|d (13)|yyyy|yyyy (2007)|yy|yy (07)|y|y (7)|th|th (10)|tm|tm (30)|ts|ts (00)|', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
('58b0f27e36d0f0c', '58af6b019f63c7e', 'zzzzsys_form', 'input', 'add_number', '+', '58af6b019f658f4', 100, 193, 473, 20, 18, '', '0', 'right', '0', '0', '', '', 'sfo_description', '', '', '', '', '', '', '', 'browse|Browse|edit|Edit|browseedit|Browse and Edit|criteria|Criteria or Home|procedure|Procedure|report|Report', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', 'button', '');
