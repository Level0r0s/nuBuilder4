...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2017 at 02:07 PM
...
('s14916371086982', 'nusample', '', 'input', 'inputnuautonumbersample', 'Input:nuAutoNumber', 's14914269237459', 70, 87, 143, 117, 18, '1', 'right', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 89, 'N|$ 1,000.00', 'nuAutoNumber', '', '', ''),
...
--
ALTER TABLE `aaaa`
  MODIFY `zzzzsys_object_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;COMMIT;
