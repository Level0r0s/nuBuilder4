...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2017 at 09:32 PM
...
('586d9964e5ab10c', 'nuobject', 'zzzzsys_object', 'run', 'calcobjects', 'Calc', '5851cf915a1c653', 460, 61, 242, 375, 275, '1', 'right', '1', '0', '', '', 'aframe', '', '', 'nucalcobjects', '#sob_all_zzzzsys_form_id#', 'i', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
...
('58b418c77ac1ea8', 'nuobject', 'zzzzsys_object', 'select', 'sob_calc_format', 'Format', '5851cf915a1c653', 430, 61, 66, 143, 18, '1', 'right', '0', '0', '', '', 'sob_input_format', '', '', '', '', '', '', '', '0', 'SELECT \n   CONCAT(LEFT(srm_type, 1), ''|'', TRIM(srm_format)) AS a, \n   srm_format AS b \nFROM zzzzsys_format\nWHERE srm_type = ''Number''', 'syt_title', 'sfo_description', '200', '', 'nutab', '', '', 'zzzzsys_tab', '', '', '', '', '', '', '', 'text', '', ''),
