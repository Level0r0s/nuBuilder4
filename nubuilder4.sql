...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2017 at 05:24 AM
...
('s15028829289851', 's15028829289845', 'invoice', 'input', 'fieldname', 'Field Name', 's15028829289846', 50, 50, 150, 200, 18, '1', 'left', '0', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 'nuScroll', 'window.nuReportList', '', ''),
...
('s15028831569405', 's15028831569399', 'Launch Form 0', 'lookup', 'table', 'Table', 's15028831569400', 10, 31, 103, 100, 20, '1', 'left', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', 'code', 'description', '200', '', 's14993014809858', 'eval("window.nuReportList = " + $(''#fieldlist'').val());\n\n$(''#list'').val(window.nuReportList.join("\\n"));\n\n\n', '', 'zzzzsys_report_data', '', '', '', '', '', '', 0, 'N|$ 1,000.00', 'nuScroll', '[''North'',''South'',''East'',''West'']', '', ''),
...
('s15029225871322', 's15028831569399', 'Launch Form 0', 'textarea', 'list', ' ', 's15028831569400', 30, 31, 938, 235, 203, '1', 'left', '0', '1', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''adiv'' style=''text-align:center;width:117px;border:1px solid red;'' class=''nuBreadcrumb''>\n    Hello World\n</div>', ''),
...
('s15029345968752', 's15028831569399', 'Launch Form 0', 'word', 'wrd3', '<b>Field Name </b> Choices', 's15028831569400', 30, 10, 938, 235, 25, '1', 'left', '0', '0', '', '', '', '', '', '', '', 'SELECT COUNT(*) FROM zzzzsys_debug', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 'N|$ 1,000.00', '', '', '<div id=''adiv'' style=''text-align:center;width:117px;border:1px solid red;'' class=''nuBreadcrumb''>\n    Hello World\n</div>', ''),
